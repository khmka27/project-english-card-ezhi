...
import { Card, Image, ProgressBar, Button, Row, Col, Container } from 'react-bootstrap';
        ...
        <Card.Body>
          ...
          {activeTab === 'progress' && (
            <div className="mt-4">
              ...
              <ProgressBar striped animated now={60} label="60%" className="mb-2" />
              <ProgressBar striped animated now={80} label="80%" className="mb-2" />

...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Themes', [
      {
        nameTheme: 'Еда',
        image: 'client/public/food.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        nameTheme: 'Дом',
        image: 'client/public/home.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        nameTheme: 'Семья',
        image: 'client/public/family.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        nameTheme: 'Путешествия',
        image: 'client/public/adventure.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        nameTheme: 'Школа',
        image: 'client/public/school.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        nameTheme: 'Мои карточки',
        image: 'client/public/mycards.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        nameTheme: 'Природа',
        image: 'client/public/nature.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        nameTheme: 'Животные',
        image: 'client/public/animal.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        nameTheme: 'Транспорт',
        image: 'client/public/cars.svg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ]);
